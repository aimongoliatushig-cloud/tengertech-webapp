      ...
      ? [
          {
            ...
            note: "Эхлээд ажлаа сонгоод тухайн ажлын дотор шинэ даалгавар нээнэ.",
      ...
      ? [
          {
            ...
            note: workerMode
              ? "Эхлээд идэвхтэй ажлаа сонгоод, дараа нь тухайн ажлын даалгавраас тайлангийн цонх руу орно."
              : "Зөвхөн идэвхтэй ажлууд харагдаж, тэр ажлаас тайлан оруулах даалгавраа сонгоно.",
            href: "/create/report",
          ...
          <div className={shellStyles.pageContent}>
            ...
            <section className={styles.mobileCreateHome} aria-label="Шинэ ажил үүсгэх mobile урсгал">
              ...
              <div className={styles.mobileCreateUtilityGrid}>
                <Link href="/review" className={styles.mobileCreateUtility}>
