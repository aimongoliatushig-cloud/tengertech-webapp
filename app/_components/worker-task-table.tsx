...
export function WorkerTaskTable({
  ...
  return (
    <section className="min-w-0 rounded-2xl border border-[#E7EBE8] bg-white p-6 shadow-[0_1px_2px_rgba(20,40,30,0.04),0_1px_3px_rgba(20,40,30,0.06)]">
      ...
      <div>
        <div className="grid grid-cols-[36px_minmax(0,1fr)_140px_100px_54px] gap-4 border-b border-[#EEF3EF] px-3 pb-2.5 text-[11px] font-semibold uppercase tracking-wide text-[#8A978E]">
          <span>№</span>
          ...
          rows.map((task, index) => {
            ...
            return (
              <Link
                key={`wtt-${task.id}`}
                href={task.href}
                className="group grid grid-cols-[36px_minmax(0,1fr)_140px_100px_54px] items-center gap-4 border-b border-[#EEF3EF] px-3 py-3 transition-colors last:border-b-0 hover:bg-[#F6FBF7]"
              >
