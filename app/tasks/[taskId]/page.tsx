        ...
        <div className={shellStyles.contentWithMenu}>
          ...
          <div className={shellStyles.pageContent}>
            ...
            >
              ...
              {task.attachments.length || (canManageAttachments && !reviewFocusedMode) ? (
                <section className={styles.attachmentCard} id="task-attachments">
                        ...
                        return (
                          ...
                          >
                            ...
                            {canManageAttachments ? (
                              <form action={deleteTaskAttachmentAction} className={styles.attachmentDeleteForm}>
                                <input type="hidden" name="task_id" value={task.id} />
                                ...
                                <button
                                  ...
                                  title="Файл устгах"
                                  aria-label={`«${file.name}» файлыг устгах`}
                                >
                  ...
                  {canManageAttachments && !reviewFocusedMode ? (
                    <form action={addTaskAttachmentsAction} className={styles.attachmentUploadForm}>
                      <input type="hidden" name="task_id" value={task.id} />
                      <input
                        type="file"
                        ...
                        aria-label="Хавсаргах файл сонгох"
                      />
                      <PendingSubmitButton
                        pendingLabel="Хавсаргаж байна..."
