            ...
            <section className={styles.panel}>
              ...
              {entries.length ? (
                <div className={styles.tableWrap}>
                  <table>
                    <thead><tr><th>№</th><th>Хэрэглэгч</th><th>Нэвтрэх нэр</th><th>Сүүлд нэвтэрсэн</th><th>Төлөв</th></tr></thead>
                    <tbody>
                      {entries.map((entry, index) => {
                        ...
                        return (
                          <tr key={entry.id}>
                            ...
                            <td><span className={recent ? styles.online : entry.active ? styles.enabled : styles.disabled}>{recent ? "Саяхан идэвхтэй" : entry.active ? "Идэвхтэй" : "Идэвхгүй"}</span></td>
                          </tr>
                        );
                      })}
                    </tbody>
