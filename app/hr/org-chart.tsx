...
export const ORG_DEPARTMENTS: OrgDepartment[] = [
  ...
  },
  {
    ...
    roles: [
      ...
      { title: "ХАБЭА хяналтын ажилтан", count: 1, aliases: ["хабэа", "Хөдөлмөрийн аюулгүй байдал, эрүүл ахуйн хяналтын ажилтан"] },
  ...
  },
  {
    ...
    roles: [
      ...
      { title: "Түүвэр хог цэвэрлэгээний ажилтан", count: 8, aliases: ["түүвэр цэвэрлэгээний ажилтан"] },
    ],
  },
  {
    key: "green",
    ...
    match: ["ногоон"],
    roles: [
      { title: "Хэлтсийн дарга", count: 1, aliases: ["ногоон байгууламж, цэвэрлэгээ үйлчилгээний хэлтсийн дарга"] },
      ...
      { title: "Зам талбайн үйлчлэгч", count: 44, aliases: ["зтү"] },
      // Ногоон/цэвэрлэгээ хэлтсийн жолооч нар Odoo-д "Жолооч" гэж бүртгэлтэй.
      { title: "Жолооч", count: 10, aliases: ["хог тээврийн жолооч", "зам талбайн жолооч"] },
